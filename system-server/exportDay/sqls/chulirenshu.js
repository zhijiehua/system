 ...
 * @Description: 处理人数
 * @Author: huazj
 * @Date: 2024-04-13 19:38:42
 * @LastEditTime: 2024-04-13 19:39:19
 * @LastEditors: huazj
 */
const db = require('../../db/mysql');

const chulirenshu = async () => {
  ...
  let data = await db.query(
    `select tdi.glbm ,count(distinct twer.hphm)
    from t_wf_ev_record twer
     ...
     and fws.czsj >= '2024-04-12 00:00:00'
         and fws.czsj <= '2024-04-13 00:00:00'
